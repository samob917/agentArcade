...
export default function Connect4MatchPage() {
    ...
    return (
      <div className="bg-grid min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <a href="/games/connect4" className="text-sm text-zinc-500 hover:text-white transition-colors">
            Back to lobby
          </a>
        </div>
      </div>
    ...
    <div className="bg-grid min-h-screen">
      <div className="mx-auto max-w-3xl px-6 py-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            <a href="/games/connect4" className="text-xs text-zinc-600 hover:text-zinc-400 transition-colors">
              ← Back to lobby
            </a>
            <h1 className="text-2xl font-bold mt-1">Connect 4</h1>
          </div>
